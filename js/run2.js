function run2(){
  ...
  var E = document.getElementById("19").value;
  var P = document.getElementById("18").value;
  var M = document.getElementById("22").value;
  var R = document.getElementById("21").value;
  var L = document.getElementById("20").value;
  var e = parseInt(E)
  var p = parseInt(P)
  var m = parseInt(M)
  var r = parseInt(R)
