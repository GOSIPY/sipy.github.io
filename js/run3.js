...
function run3(){var t = 0;


setInterval(function(){
	   var E = document.getElementById("36").value;
  var P = document.getElementById("35").value;
  var M = document.getElementById("39").value;
  var R = document.getElementById("38").value;
  var L = document.getElementById("37").value;
  var e = parseInt(E)
  var p = parseInt(P)
  var m = parseInt(M)
  var r = parseInt(R)
